<form id="checkoutForm" action="validateCheckout.php" method="POST" novalidate>
    <fieldset>
        ...
        <p>
            ...
            <input type="text" name="deliveryAddress1" id="deliveryAddress1" <?php fillin("deliveryAddress1"); ?>
                   required>
        </p>
        <p>
        ...
        <p>
            ...
            <input type="text" name="deliveryPostcode" id="deliveryPostcode" <?php fillin("deliveryPostcode"); ?>
